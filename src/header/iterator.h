...
//typedefs
typedef thrust::constant_iterator<int> constIter;
...
//For generating constant reference to arbitrary thrust::vector
template<typename T>
struct gConst{
  typedef thrust::permutation_iterator<T, constIter > iterator;
};
